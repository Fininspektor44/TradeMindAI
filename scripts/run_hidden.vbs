...
runLive = fso.BuildPath(scriptDir, "run_live.ps1")
logFile = fso.BuildPath(logDir, "live.log")

cmd = "cmd.exe /d /c " & Quote(Quote(psExe) & _
      " -NoProfile -ExecutionPolicy Bypass -File " & Quote(runLive) & _
      " >> " & Quote(logFile) & " 2>&1")
