...
1. `build_ser8_historical_data_inventory.py --mode verify-source` verifies the
   ...
   authenticated account `67206924`, broker/server identity, and the real
   `mt5_risk_symbols_utc_67206924.csv` universe.
...
The content identity covers broker/server, account, symbol, timeframe,
...
& ".\.venv\Scripts\python.exe" ".\scripts\build_ser8_historical_data_inventory.py" --mode verify-source --account 67206924 --mt5-export-dir "C:\Users\meff4\AppData\Roaming\MetaQuotes\Terminal\Common\Files\TradeMindAI"
```

Stop and inspect `SOURCE_VERIFIED`, account, server, terminal identity, and the
read-only operation list before proceeding.
...
```powershell
& ".\.venv\Scripts\python.exe" ".\scripts\build_ser8_historical_data_inventory.py" --mode collect --account 67206924 --mt5-export-dir "C:\Users\meff4\AppData\Roaming\MetaQuotes\Terminal\Common\Files\TradeMindAI" --timeframe M5 --from-utc "2026-08-14T00:00:00Z" --to-utc "2026-08-21T00:00:00Z" --proof-symbol-limit 1
```
...
```powershell
& ".\.venv\Scripts\python.exe" ".\scripts\build_ser8_historical_data_inventory.py" --mode collect --account 67206924 --mt5-export-dir "C:\Users\meff4\AppData\Roaming\MetaQuotes\Terminal\Common\Files\TradeMindAI" --timeframe M5 --from-utc "2024-01-01T00:00:00Z" --to-utc "2026-08-21T00:00:00Z"
```
...
```powershell
& ".\.venv\Scripts\python.exe" ".\scripts\build_ser8_historical_data_inventory.py" --mode verify-inventory --inventory "C:\Users\meff4\Documents\TradeMindAI\data\ser8_historical_market_data\historical_inventory.json"
```
